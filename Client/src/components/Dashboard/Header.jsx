...
const Header = ({ isOpen }) => {
  ...
  return (
    ...
    >
      ...
      {/* New Capsule Button */}
      <Link
        to="/create-capsule" // Change to your desired route or use onClick handler
        className="bg-blue-500 hover:bg-blue-600 text-white text-sm px-3 py-1.5 rounded-lg transition-all duration-200"
      >
        + New Capsule
      </Link>
